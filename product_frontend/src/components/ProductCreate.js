          ...
          <Form >
            ...
            <div className="input-group ">
              <span
                ...
                style={{ width: 200 }}
              >
                Tên sản phẩm<small style={{ color: "red", marginLeft: "0.5rem" }}> *</small>
              </span>
              <Field
                type="text"
            ...
            <div className="input-group ">
              <span
                ...
                style={{ width: 200 }}
              >
                Mã sản phẩm<small style={{ color: "red", marginLeft: "0.5rem" }}> *</small>
              </span>
              <Field
                type="text"
                className="form-control"
            ...
            <div style={{ height: 20, color: "red" }}>
              <ErrorMessage name="code" style={{ marginLeft: "27%", paddingBottom: 10 }} />
            </div>
            <div className="input-group ">
              <span
                className="input-group-text mx-auto"
            ...
            <div className="input-group mb-3 ">
              ...
              <Field as="select" className="form-select" id="inputGroupSelect01" name="type">
                {
